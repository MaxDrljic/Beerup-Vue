<template>
  <div class="col-xl-4 col-md-6 col-xs-12 side-container">
    ...
    <!-- CRATE TABS -->
    <ul class="nav nav-tabs justify-content-center crate-tabs" id="crateTab" role="tablist">
      <li class="nav-item crate-item">
        <a
          ...
          aria-selected="true"
        >
          <span class="crate-span" :class="{ disabledSpan: activeCrate1 === true }">ONE</span>
        </a>
      </li>
      <li class="nav-item crate-item">
        <a
          ...
          aria-selected="false"
        >
          <span class="crate-span" :class="{ disabledSpan: activeCrate2 === true }">TWO</span>
        </a>
      </li>
      <li class="nav-item crate-item">
        <a
          ...
          aria-selected="false"
        >
          <span class="crate-span" :class="{ disabledSpan: activeCrate3 === true }">THREE</span>
        </a>
      </li>
    </ul>
